...
<div class="mdl-grid demo-content" ng-controller="ExaminationListCardsController">
    ...
    <div class="demo-charts mdl-color--white mdl-shadow--2dp mdl-cell mdl-cell--12-col mdl-grid">
        ...
        <div ng-repeat="examination in examinations"
            ...
            <div class="mdl-card__title mdl-card--expand mdl-color--teal-300">
                <h2 class="mdl-card__title-text">@{{ examination.name }}</h2>
            </div>
            ...
            <div class="mdl-card__actions mdl-card--border">
                ...
                <a ui-sref="examinationEdit" class="mdl-button mdl-js-button mdl-js-ripple-effect">Edit</a>
            </div>
        </div>
    </div>
</div>
